<%@ Page Title="" Language="C#" MasterPageFile="~/Master.Master" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="GroupProject_Web.Login" %>
                    ...
                    <div class="contact_form_container">
                        ...
                        <form id="contact_form" runat="server">
                            <div class="contact_form_inputs d-flex flex-md-row flex-column justify-content-between align-items-between">
                                <input type="text" id="name" class="contact_form_name input_field" placeholder="Your username" required="required" data-error="Email is required." runat="server">
